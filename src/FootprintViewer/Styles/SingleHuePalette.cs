...
public class SingleHuePalette : ISingleHuePalette
{
    public static SingleHuePalette Oranges => CreateOrangesPalette();
    public static SingleHuePalette Reds => CreateRedsPalette();
    public static SingleHuePalette Greens => CreateGreensPalette();
    public static SingleHuePalette Purples => CreatePurplesPalette();
    public static SingleHuePalette Greys => CreateGreysPalette();
    public static SingleHuePalette Blues => CreateBluesPalette();

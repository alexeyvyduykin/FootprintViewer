        ...
        private void InvalidateTimerCallback(object? state)
        {
            ...
            */
            ...
            After:
                        if (!Animation.UpdateAnimations() && !_refresh)
            */
 //           if (!Mapsui.Utilities.Animation.UpdateAnimations() && !_refresh)
 //               return;
...
#pragma warning restore IDISP007 // Don't dispose injected
        ...
        /// <inheritdoc />
        public mg.Point ToPixels(mg.Point coordinateInDeviceIndependentUnits)
        {
            return new mg.Point(
        ...
        /// <inheritdoc />
        public mg.Point ToDeviceIndependentUnits(mg.Point coordinateInPixels)
        {
            return new mg.Point(coordinateInPixels.X / PixelDensity, coordinateInPixels.Y / PixelDensity);
        }

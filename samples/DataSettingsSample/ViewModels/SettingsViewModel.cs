...
public class SettingsViewModel : DialogViewModelBase<IList<DbKeys>>
{
    ...
    public SettingsViewModel(Repository repository)
    {
        ...
        {
            new ProviderViewModel(this, DbKeys.Footprints)
            {
            ...
            new ProviderViewModel(this, DbKeys.GroundTargets)
            {
            ...
            new ProviderViewModel(this, DbKeys.Satellites)
            {
            ...
            new ProviderViewModel(this, DbKeys.GroundStations)
            {
            ...
            new ProviderViewModel(this, DbKeys.UserGeometries)
            {

...
namespace InteractivitySample.ViewModels
{
    public class MainViewModel : ReactiveObject
    {
        ...
        private static readonly CustomProvider _provider = new CustomProvider();
        ...
        public static Map CreateMap()
        {
            ...
            _provider.Clear();
            _provider.AddFeature("Polygon", wktPolygon/*, CreatePolygonStyle()*/);
            _provider.AddFeature("Circle", wktCircle/*, CreateCircleStyle()*/);
            _provider.AddFeature("Rectangle", wktRectangle/*, CreateRectangleStyle()*/);
            _provider.AddFeature("Route", wktRoute/*, CreateRouteStyle()*/);

            var userLayer = CreateLayer(_provider);
